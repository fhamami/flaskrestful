...
class BucketlistTestCase(unittest.TestCase):
    """ This represents the bucketlists test case """

    def setUp(self):
        """ Define test variabels and initialize app """
    ...
    def tearDown(self):
        """ teardown all initialized variabels """
        with self.app.app_context():
            # drop all tables
            db.session.remove()
            db.drop_all()

# make the tests conventiently executable
